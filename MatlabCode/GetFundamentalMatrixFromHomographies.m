function Fund = GetFundamentalMatrixFromHomographies(H, pts1, pts2, img_size)
    ...
    for i = 1 : 5
       hallu_pts2(:,i) = hallu_pts2(:,i) / hallu_pts2(3,i);
    end
     
    hallu_pts1 = [hallu_pts1'; pts1, repmat(1,5,1)]';
    hallu_pts2 = [hallu_pts2'; pts2, repmat(1,5,1)]';

    for i = 1 : size(hallu_pts1, 2)
       pt1 = hallu_pts1(:,i);
       pt2 = hallu_pts2(:,i);
    ...
    Fund = [];
    pts1h = [pts1(1:5,:) repmat(1, 5, 1)]';
    pts2h = [pts2(1:5,:) repmat(1, 5, 1)]';
